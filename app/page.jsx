  ...
  return (
    <div className="flex flex-col text-red-100 ">
      <div className=" flex flex-col md:flex-row w-full h-[600px] gap-20 items-center md:items-baseline " >
        ...
        <div className="h-full flex flex-col gap-5  md:flex-row md:items-start " >
          {/* Text Container */}
          <div className="flex flex-col gap-8 h-1/2 items-center md:items-start md:mt-40 ">
            ...
            <p className="text-xl text-center md:text-start" >
              As a frontend developer, I combine aesthetics and functionality to build responsive, user-focused interfaces using modern web technologies.
            </p>
            {/* Button */}
            <div className="w-[150px] md:mt-5 " >
          ...
          {/* Image Container  */}
          <div className="h-1/2 flex  justify-center rounded-lg md:mt-[7rem]">
            <ProfileFrame />
          </div>
        </div>
      </div>
